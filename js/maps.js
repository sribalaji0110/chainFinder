...
(function ($) {
  ...
  function singleListingMappopup() {
    ...
    var single_map_popup = new google.maps.Map(
      document.getElementById("singleListingMappopup"),
      {
        zoom: 15,
    ...
    function ZoomControl(controlDiv, single_map_popup) {
      zoomControlDiv.index = 1;
      single_map_popup.controls[google.maps.ControlPosition.RIGHT_CENTER].push(
        zoomControlDiv
      );
      controlDiv.style.padding = "5px";
    ...
    var singleMapIco_popup =
      "<i class='" + $("#singleListingMappopup").data("map-icon") + "'></i>";
    new CustomMarker(
      myLatlng,
      single_map_popup,
      {
